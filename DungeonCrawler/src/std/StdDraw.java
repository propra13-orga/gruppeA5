...
public final class StdDraw{
	...
	//TODO: pictureXXX methods still throw an uncaught exception if image could not be loaded.
    ...
    /*
     * Will be called from StdWin. Has to be called once before StdDraw methods can work.
     */
    ...
    *************************************************************************/
    ...
    /**
     * Draw a circle of diameter d, the x and y describes the top-left coordinate.
     * @param x the x-coordinate of the top-left corner of the box encompassing the circle
     * @param y the y-coordinate of the top-left corner of the box encompassing the circle
     * @param d the diameter of the cricle
     * @throws RuntimeException if the radius of the circle is negative
     */
    public static void circle(double x, double y, double d) {
        if (d < 0) throw new RuntimeException("circle diameter can't be negative");
        double xs = scaleX(x);
        double ys = scaleY(y);
        double ws = factorX(d);
        double hs = factorY(d);
    ...
    /**
     * Draw a filled circle of diameter d, the x and y describes the top-left coordinate.
     * @param x the x-coordinate of the top-left corner of the box encompassing the circle
     * @param y the y-coordinate of the top-left corner of the box encompassing the circle
     * @param d the diameter of the cricle
     * @throws RuntimeException if the radius of the circle is negative
    ...
    /**
     * Draw an ellipse with given semimajor and semiminor axes.
     * @param x the x-coordinate of the top-left corner of the box encompassing the ellipse
     * @param y the y-coordinate of the top-left corner of the box encompassing the ellipse
     * @param bottomX the x-coordinate of the bottom-right corner of the box encompassing the ellipse
     * @param bottomY the y-coordinate of the bottom-right corner of the box encompassing the ellipse
     * @throws RuntimeException if either of the axes are negative
     */
    ...
    /**
     * Draw a square of side length 'length'.
     ...
     * @param length is the corner-to-corner distance of each side
     * @throws RuntimeException if r is negative
     */
    ...
    /**
     * Draw a filled square of side length 'length'.
     * @param x the x-coordinate of the top-left corner of the square
     * @param y the y-coordinate of the top-left corner of the square
     * @param length is the corner-to-corner distance of each side
     * @throws RuntimeException if r is negative
    ...
    /**
     * Draw a filled rectangle of given width and height.
     * @param x the x-coordinate of the top-left corner of the rectangle
     * @param y the y-coordinate of the top-left corner of the rectangle
     * @param width is the width of the rectangle
     * @param height is the height of the rectangle
    ...
    *************************************************************************/
    ...
    /**
     * Draw picture (gif, jpg, or png), rotated given number of degrees
     * @param x the top-left x-coordinate of the image
     * @param y the top-left y-coordinate of the image
     * @param s the name of the image/picture, e.g., "ball.gif"
     * @param degrees is the number of degrees to rotate counterclockwise
    ...
    /**
     * Draw picture (gif, jpg, or png), rescaled to w-by-h.
     * @param x the top-left x coordinate of the image
     * @param y the top-left y coordinate of the image
     * @param s the name of the image/picture, e.g., "ball.gif"
     * @param w the width of the image
    ...
    /**
     * Draw picture (gif, jpg, or png), rotated given number of degrees, rescaled to w-by-h.
     * @param x the top-left x-coordinate of the image
     * @param y the top-left y-coordinate of the image
     * @param s the name of the image/picture, e.g., "ball.gif"
     * @param w the width of the image
